...
export const claimLead = async (req, res) => {
  try {
    ...
    // Any BDA may claim an unclaimed lead. Client-level ownership is no longer
    // enforced here — the only gate is whether the lead is already claimed (checked
    // above). originalBda is still recorded below for attribution/reporting.
